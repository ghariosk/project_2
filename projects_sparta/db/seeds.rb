...
### 2 users to test admin changes
  ...
  UserProject.create!(user_id: u2.id, project_id: p3.id )
  UserProject.create!(user_id: u2.id, project_id: p4.id )



  Like.create!(user_id:u1.id, project_id: p2.id)
  Like.create!(user_id:u1.id, project_id:p3.id)
  Like.create!(user_id:u1.id, project_id:p4.id)

  Like.create!(user_id:u2.id, project_id:p2.id)
  Like.create!(user_id:u2.id , project_id:p1.id)
